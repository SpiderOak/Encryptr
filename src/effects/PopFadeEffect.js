    ...
    Encryptr.prototype.PopFadeEffect = window.BackStack.Effect.extend({
        ...
        play:function ($fromView, $toView, callback, context) {
            ...
            if ($toView) {
                ...
                $toView.css({'opacity': 0, '-webkit-transform': 'scale3d(0.95,0.95,0.95)', 'transform':'scale3d(0.95,0.95,0.95)'});
            ...
            if ($fromView) $fromView.css({'opacity':0, '-webkit-transform':'scale3d(0.95,0.95,0.95)', 'transform':'scale3d(0.95,0.95,0.95)'});
        }
    });
